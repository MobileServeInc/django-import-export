...
class Resource(six.with_metaclass(DeclarativeMetaclass)):
    ...
    def save_instance(self, instance, data, using_transactions=True, dry_run=False):
        """
        ...
        """
        self.before_save_instance(instance, data, using_transactions, dry_run)
        if not using_transactions and dry_run:
            # we don't have transactions and we want to do a dry_run
            pass
        else:
            instance.save()
        self.after_save_instance(instance, data, using_transactions, dry_run)

    def before_save_instance(self, instance, data, using_transactions, dry_run):
        """
        Override to add additional logic. Does nothing by default.
        """
        pass

    def after_save_instance(self, instance, data, using_transactions, dry_run):
        """
        Override to add additional logic. Does nothing by default.
        """
        pass
    ...
    def skip_row(self, instance, original, data):
        ...
        if not self._meta.skip_unchanged:
            return False, ""
        # for field in self.get_fields(): # old way
        for field in self.get_import_fields():
            try:
